/**
 * OpenTake Extension System — Core Types
 *
...
// ---------------------------------------------------------------------------
// Extension Manifest (opentake-extension.json)
// ---------------------------------------------------------------------------
...
export interface ExtensionManifest {
	...
	license?: string;
	/** Minimum OpenTake version required */
	engine?: string;
 ...
 *
 * OpenTake does not auto-register these entries at runtime today.
...
export interface OpenTakeExtensionAPI {
...
export interface OpenTakeExtensionModule {
	/** Called when the extension is activated */
	activate(api: OpenTakeExtensionAPI): void | Promise<void>;
