...
export default function VideoEditor() {
	...
	const projectDisplayName = useMemo(() => {
		const fileName =
			...
			"";
		const withoutExtension = fileName.replace(/\.opentake$/i, "").replace(/\.[^.]+$/, "");
	...
	useEffect(() => {
		...
		// When smoke-export opens a .opentake project, the cursor telemetry
					...
					<DialogHeader>
						...
						<DialogDescription className="text-muted-foreground">
							{t(
								...
								"Name this project. It will be saved in your OpenTake Projects folder.",
							)}
						</DialogDescription>
					</DialogHeader>
					<div className="py-4">
				...
				<DialogHeader>
					...
					<DialogDescription className="text-muted-foreground">
						{t(
							...
							"Your device does not support native capture. This could be for a variety of reasons we haven’t figured out yet. This doesn’t break OpenTake, but it does make cursor smoothing impossible.",
						)}
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
