...
export type ZoomTransitionEasing = "opentake" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "opentake";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "opentake";
