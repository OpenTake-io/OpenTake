...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\OpenTake\\recording-1.mp4", "mic")).toEqual([
			"C:/OpenTake/recording-1.mic.wav",
			"C:/OpenTake/recording-1.mic.m4a",
			"C:/OpenTake/recording-1.mic.webm",
		]);
	});
